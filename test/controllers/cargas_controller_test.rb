...
class CargasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carga" do
    assert_difference('Carga.count') do
      post cargas_url, params: { carga: { archivo: @carga.archivo, estado: @carga.estado, user_id: @carga.user_id } }
    end
  ...
  test "should update carga" do
    patch carga_url(@carga), params: { carga: { archivo: @carga.archivo, estado: @carga.estado, user_id: @carga.user_id } }
